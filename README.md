...
#### React
9. Could you describe the React component lifecycle? When in the lifecycle would you bind to events?
   - ...
10. When do you prefer to use the Ref attribute?
...
12. How do you decide between using a functional VS a class component?
...
13. What's the difference between a pure component and a regular component?
   - TODO: complete
14. What sort of patterns do you employ when developing forms in React?
...
15. What happens when I enter my username & password into a form & hit login? Describe at as low a level as you can.
...
#### Security
16. What happens when the username & password reach the server? How does the server verify if the password is correct?
...
17. How can a user stay logged in, so they don't need to & password?
...
18. Can the company retrieve your password for you?
...
19. What is SQL injection? How do you prevent it?
...
20. Architect a scaled down Facebook app, with a feed display, and a posts display, many users, many posts. FOLLOWUP: How do you make it so anyone can get to it?
   - ...
21. When you have lots of traffic and the website is slow, how do you determine where the bottleneck is, and how would you fix it? FOLLOWUP: If the bottleneck if the server, how would you fix it?
   - ...
22. How do you securely transmit data?
   - ...
23. How do you get your React / Angular / Vue / etc... app onto the server?
   - ...
24. Tell me about a time you missed a deadline, what happened, and how did you fix it?
   - ...
25. Tell me about a time you've worked harder than you should've, and why you did it?
   - ...
26. What browser do you use to develop and why?
   - Chrome, dev tools features

#### Page Load Speed
27. What are things you can do to improve page load speed?
...
#### Workflow
28. What's the difference between a text editor & an IDE?
...
31. What CSS would you use to turn a <span> into a <button>?
    - TODO: finish
32. Describe the cascading part of CSS
    - TODO: finish
33. What HTML & CSS would you use to make a horizontal nav bar?
    - TODO: finish
34. What is a float?
...
32. How would you handle someone who approaches you with a project management triangle? (price, speed, cost)
    - TODO: finish
33. You're leading a team that's behind on a deliverable. How do you motivate them to get it done?
    - TODO: finish